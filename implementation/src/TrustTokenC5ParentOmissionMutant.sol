...
contract TrustTokenC5ParentOmissionMutant is TrustStorage, IERC20, IERC7943Fungible, IERCTrust {
    ...
    function _popEffect(
        ...
        head.actionId = bytes32(0); // MUTATION: parent restoration omitted.
