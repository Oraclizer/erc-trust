...
contract TrustTokenC4FreezeIncrementMutant is TrustStorage, IERC20, IERC7943Fungible, IERCTrust {
        ...
        returns (bytes32 receiptHash)
    {
        ...
        if (request.action == TrustTypes.ActionKind.FREEZE) {
            ...
            _frozen[request.subject] += request.amount; // MUTATION: incremental FREEZE.
