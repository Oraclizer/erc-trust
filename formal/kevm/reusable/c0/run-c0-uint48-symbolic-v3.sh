...
source_manifest="$repository_root/formal/kevm/reusable/c0/uint48-symbolic-word-v3/source-manifest-v3.json"
...
readonly expected_source_manifest=103853672dd9515523357a69e934cd6ea4398e66151f658706c7813df9cc8e3d
...
if claim is None:
    raise SystemExit(f"unknown UINT48 v3 claim: {claim_id}")
...
native_root=$(mktemp -d /tmp/erc-trust-c0-uint48-v3-XXXXXX)
