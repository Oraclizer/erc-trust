...
const claimPath = resolve(import.meta.dirname, "full-transaction-v1/full-transaction-finalization-spec.k");
const manifestPath = resolve(import.meta.dirname, "full-transaction-v1/manifest.json");
...
const report = {
  ...
  inputs: {
    claim: { path: "formal/kevm/row-bundles/act-01/full-transaction-v1/full-transaction-finalization-spec.k", sha256: fileSha256(claimPath) },
    manifest: { path: "formal/kevm/row-bundles/act-01/full-transaction-v1/manifest.json", sha256: fileSha256(manifestPath) },
