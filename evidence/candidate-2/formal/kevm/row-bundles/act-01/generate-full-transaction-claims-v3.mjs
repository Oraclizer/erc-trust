...
//
// usage:
//   node generate-full-transaction-claims-v3.mjs --state-capture-root <feasibility output root>
//
...
if (inputIndex < 0 || !process.argv[inputIndex + 1]) {
  throw new Error("usage: node generate-full-transaction-claims-v3.mjs --state-capture-root <path>");
}
const inputRoot = resolve(process.argv[inputIndex + 1]);
const outputRoot = resolve(import.meta.dirname, "full-transaction-v3");
const generatorPath = resolve(import.meta.dirname, "generate-full-transaction-claims-v3.mjs");
...
const manifest = {
  ...
  generator: {
    path: "formal/kevm/row-bundles/act-01/generate-full-transaction-claims-v3.mjs",
  ...
  claims: [
    { path: "formal/kevm/row-bundles/act-01/full-transaction-v3/full-transaction-finalization-spec.k", sha256: finalizeSha256, module: "TRUST-ACT-01-FULL-TRANSACTION-FINALIZATION-SPEC" },
    { path: "formal/kevm/row-bundles/act-01/full-transaction-v3/full-transaction-event-order-spec.k", sha256: eventSha256, module: "TRUST-ACT-01-FULL-TRANSACTION-EVENT-ORDER-SPEC" },
  ],
  expected: {
    finalFrozenTarget: "1",
    lifecycle: "APPLIED",
