...
import {TrustTokenC5ParentOmissionMutant} from "../../src/TrustTokenC5ParentOmissionMutant.sol";
import {TrustTypes} from "../../src/TrustTypes.sol";

contract TrustTokenC5ReversalHarness is TrustTokenC5ParentOmissionMutant {
    ...
    constructor(
        ...
        TrustTokenC5ParentOmissionMutant(
            name_,
            symbol_,
            decimals_,
            governor_,
