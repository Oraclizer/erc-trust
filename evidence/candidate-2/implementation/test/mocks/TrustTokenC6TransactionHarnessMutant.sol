...
import {TrustTokenC6ReceiptBindingOmissionMutant} from "../../src/TrustTokenC6ReceiptBindingOmissionMutant.sol";
...
contract TrustTokenC6TransactionHarness is TrustTokenC6ReceiptBindingOmissionMutant {
    ...
    constructor(
        ...
        TrustTokenC6ReceiptBindingOmissionMutant(
            name_,
            symbol_,
            decimals_,
            governor_,
