...
const attributionNames = ["ChatGPT", "OpenAI", "Anthropic", "Clau" + "de", "Co" + "dex"].join("|");
const attributionPattern = new RegExp(`\\b(?:${attributionNames})\\b|AI[- ]generated|generated by AI`, "i");
