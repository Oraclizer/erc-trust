...
export function eligibleRun(run, pr, repository) {
  // The supplemental pull_requests list can be empty or refer to a newer PR
  // on a reused branch. The caller binds the commit to the merged PR; the
  // immutable run head and repository checks below establish the source match.
